...
- (void)setUserId:(nullable NSString *)userId {
  ...
  @synchronized(self) {
    BOOL sameUserId = (!userId && !self.currentUserIdInfo.userId) || (userId && self.currentUserIdInfo.userId && [self.currentUserIdInfo.userId isEqualToString:(NSString *)userId]);
    if (sameUserId) {
      return;
    }
